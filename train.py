...
def train(config):
    ...
    solver = Solver(model, config, max_steps_burn_in=max_step_burn_in, apex=None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/configs/yolo3d_5m.yaml', help='*.yaml path')
